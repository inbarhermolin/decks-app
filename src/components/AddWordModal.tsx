...
export function AddWordModal({ onAdd, onClose, decks, defaultDeckId }: Props) {
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between px-6 py-5 border-b border-[#1C1E35]">
            <div>
              <h2 className="text-base font-bold text-white">Add New Word</h2>
              <p className="text-xs text-slate-500 mt-0.5">Fill in the details or let AI do the work</p>
            </div>
            <button
              type="button"
              onClick={onClose}
